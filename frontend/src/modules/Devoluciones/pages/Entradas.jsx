...
import {
  ...
  Search, X, Clock, Eye, Trash2, AlertTriangle, ChevronUp, ChevronDown,
} from 'lucide-react'
  ...
  return (
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {/* Status tabs */}
        <div className="flex gap-0 border-b border-warm-100 bg-white px-5 overflow-x-auto scrollbar-none">
          {STATUS_TABS.map(({ id }) => (
            <button
              key={id}
        ...
        <div className="p-4">
          <motion.div className="card overflow-hidden table-shell"
            ...
            {isLoading ? (
              <LoadingSpinner text={t('dev.entradas.loading')} />
            ) : sesiones.length === 0 ? (
