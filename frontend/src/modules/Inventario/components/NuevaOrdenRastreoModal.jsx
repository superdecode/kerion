...
export default function NuevaOrdenRastreoModal({ isOpen, onClose, usuarios = [], onCreated }) {
  ...
  function buildCreateBody(force = false) {
    ...
    return {
      ...
      receiver_name: tab === 'con_orden' ? outboundDetail?.receiverName || undefined : undefined,
      logistics_track_no: tab === 'con_orden' ? outboundDetail?.logisticsTrackNo || outboundDetail?.trackingNo || undefined : undefined,
      third_order_no: tab === 'con_orden' ? outboundDetail?.thirdOrderNo || undefined : undefined,
      logistics_channel: tab === 'con_orden' ? outboundDetail?.logisticsChannel || undefined : undefined,
      outbound_delivery_at: tab === 'con_orden' ? outboundDetail?.outboundTime || outboundDetail?.expectedTime || undefined : undefined,
