                            ...
                            <tbody className="divide-y divide-warm-50">
                              {guiasPage.map((g, i) => (
                                <tr key={g.codigo_guia + i} className="table-row">
                                  ...
                                  <td className="table-cell"><span className="code-main">{g.codigo_guia}</span></td>
                                  <td className="table-cell code-main">{g.tarima_codigo}</td>
                        ...
                        {guiaPages > 1 && (
                          <div className="flex items-center justify-between px-5 py-3 border-t border-warm-100 bg-warm-50/30">
                            <p className="text-xs text-warm-400">
                              {t('common.pagination.page')} {guiaPage} {t('common.pagination.of')} {guiaPages} · {guias.length} guías
                            </p>
                                          ...
                                          <tbody>
                                            {tGuias.map((g, i) => (
                                              <tr key={g.codigo_guia + i} className="border-b border-warm-50 last:border-0">
                                                ...
                                                <td className="pr-4"><span className="code-main">{g.codigo_guia}</span></td>
