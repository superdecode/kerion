    ...
    <div className="flex flex-col h-full">
            ...
            <div className="flex items-center gap-1.5">
              ...
              {hasActiveFilters && (
                <button onClick={clearFilters} className="inline-flex items-center gap-1 text-xs text-primary-600 font-semibold">
                  <X className="w-3 h-3" /> {t('dev.salidas.clear')}
                </button>
              )}
            </div>
      ...
      >
        <p className="text-sm text-warm-600">
          {t('dev.salidas.cancel.modal.body')} <span className="font-semibold font-mono text-warm-800">{cancelRow?.codigo}</span>?
        </p>
      </Modal>
      ...
      >
        <p className="text-sm text-warm-600">
          {t('dev.salidas.delete.modal.body')} <span className="font-semibold font-mono text-warm-800">{deleteRow?.codigo}</span>? {t('dev.salidas.delete.body')}
        </p>
      </Modal>
