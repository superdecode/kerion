      ...
      <div className="flex flex-wrap items-center gap-2.5 text-[11px] text-warm-500">
        ...
        <label className="flex items-center gap-1.5">
          ...
          <select
            ...
            className="h-8 rounded-lg border border-warm-200 bg-warm-50 px-2.5 text-[11px] font-medium text-warm-700 outline-none transition-colors focus:border-primary-400 focus:ring-2 focus:ring-primary-100"
          >
      ...
      <div className="flex items-center justify-between gap-1.5 md:justify-end">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            disabled={safePage === 1}
            className="inline-flex h-7 w-7 items-center justify-center rounded-full border border-warm-200 bg-white/90 text-warm-500 transition-all hover:border-primary-200 hover:bg-primary-50 hover:text-primary-700 disabled:opacity-30 disabled:hover:border-warm-200 disabled:hover:bg-white/90 disabled:hover:text-warm-500"
          >
          ...
          <span className="inline-flex h-7 min-w-7 items-center justify-center rounded-full border border-primary-300 bg-white px-2 text-[10px] font-semibold text-primary-700 shadow-[0_0_0_3px_rgba(124,58,237,0.10)]">
            {safePage}
          </span>
          <button
